...
def getLinewidth_kappa(N_em, g, gamma2, gamma, pump):
    ###IMPORT DATA
    ...
    pump_list_ss=out_ss['kappa_List']
    ## calculate linewidth ##
    ...
    np.savez('./data/{}-emitter_kappa-sweep_linewidth_g={}_gam2={}_gam={}_pump={}.npz'.format(N_em,g,gamma2,gamma,pump),wlist=wlist,linewidth=linewidth)