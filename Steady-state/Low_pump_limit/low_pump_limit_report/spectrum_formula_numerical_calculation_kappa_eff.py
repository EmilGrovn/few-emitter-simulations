...
for ele,kappa in enumerate(kappa_list_eff):
    print('kappa',kappa)
...
np.savez('./data/spectrum_eff_formula_linewidth_g={}_gamD={}_gamA={}.npz'.format(g,gammaD,gammaA),kappa_list=kappa_list,linewidth_list=linewidth_list)
