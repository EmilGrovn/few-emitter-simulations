...
def getLinewidth_gammaA(N_em, g, gamma2, kappa, pump):
    ###IMPORT DATA
    ...
    pump_list_ss=out_ss['gammaA_List']
    print(len(pump_list_ss))
    ## calculate linewidth ##
    ...
    np.savez('./data/{}-emitter_gammaA-sweep_linewidth_g={}_gam2={}_kap={}_pump={}.npz'.format(N_em,g,gamma2,kappa,pump),wlist=wlist,linewidth=linewidth)