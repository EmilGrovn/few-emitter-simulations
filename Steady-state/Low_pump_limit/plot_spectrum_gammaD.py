...
ax1.contourf(np.log10(gammaD_list), wlist,(spectrum_matrix).transpose(), 20, cmap='RdGy')
...
#save plot
plt.savefig('./plots/spectrumplot_{}-emitter_gammaD-sweep_g={}_kap={}_gam={}_pump={}.pdf'.format(N_em,g,kappa,gamma,pump))
plt.show()